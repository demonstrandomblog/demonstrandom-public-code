...
| [Game invariant coordinates](games/invariant_coordinates/) | Game classes, Hodge decomposition, response cycles, polynomial coordinates and candidate atlases | [Invariant Coordinates for Normal-Form Games](https://demonstrandom.com/symmetry/posts/invariant_coords_normal_form_games_v2/) |
...
| [Lie groups and variational integration](games/geometric_controls/) | Lie groups, variational integration, pendulum, rotor and Kepler scaling | [Controls from the Geometric Perspective](https://demonstrandom.com/game_theory/posts/discrete_controls_lagrange/index.html); [Noether's Theorem and Geometric Controls](https://demonstrandom.com/game_theory/posts/noether_geometric_controls/); [Noether with Time](https://demonstrandom.com/game_theory/posts/noether_time/); [Dynamical Similarity](https://demonstrandom.com/game_theory/posts/dynamical_similarity/) |
